<template>
  ...
  <div>
    <main class="rounded-lg shadow-lg p-4 md:p-8 bg-slate-100 dark:bg-gray-800 transition-colors duration-300 w-full mx-auto" style="min-height: 700px;">
      ...
      <p class="text-gray-600 dark:text-gray-400 text-center mb-12 mx-auto">Effortlessly adapt your images for social media with quick file size reduction and format conversion.</p>
